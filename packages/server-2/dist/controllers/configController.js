...
let ConfigController = class ConfigController extends tsoa_1.Controller {
    constructor() {
        super(...arguments);
        this.configService = new services_1.ConfigService();
    }
    getAllConfigOptions() {
        return Object.fromEntries(this.configService);
    }
    getConfigOptionByKey(key) {
...
], ConfigController.prototype, "getAllConfigOptions", null);
__decorate([
    tsoa_1.Get("{key}"),
    ...
    __metadata("design:returntype", void 0)
], ConfigController.prototype, "getConfigOptionByKey", null);
