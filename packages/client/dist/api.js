...
exports.DefaultApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllStrategies: (options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        writeStrategy: (fileName, writeStrategyOptions, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'fileName' is not null or undefined
            if (fileName === null || fileName === undefined) {
                throw new base_1.RequiredError('fileName', 'Required parameter fileName was null or undefined when calling writeStrategy.');
            }
            ...
            if (writeStrategyOptions === null || writeStrategyOptions === undefined) {
                throw new base_1.RequiredError('writeStrategyOptions', 'Required parameter writeStrategyOptions was null or undefined when calling writeStrategy.');
            }
            const localVarPath = `/strategy/{fileName}`
                .replace(`{${"fileName"}}`, encodeURIComponent(String(fileName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
exports.DefaultApiFp = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllStrategies(options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield exports.DefaultApiAxiosParamCreator(configuration).getAllStrategies(options);
                return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                    const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: ((configuration === null || configuration === void 0 ? void 0 : configuration.basePath) || basePath) + localVarAxiosArgs.url });
                    return axios.request(axiosRequestArgs);
                };
         ...
         * @throws {RequiredError}
         */
        writeStrategy(fileName, writeStrategyOptions, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield exports.DefaultApiAxiosParamCreator(configuration).writeStrategy(fileName, writeStrategyOptions, options);
                return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                    const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: ((configuration === null || configuration === void 0 ? void 0 : configuration.basePath) || basePath) + localVarAxiosArgs.url });
                    return axios.request(axiosRequestArgs);
                };
...
exports.DefaultApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getAllStrategies(options) {
            return exports.DefaultApiFp(configuration).getAllStrategies(options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @param {'port' | 'appDir'} key
         ...
         */
        writeStrategy(fileName, writeStrategyOptions, options) {
            return exports.DefaultApiFp(configuration).writeStrategy(fileName, writeStrategyOptions, options).then((request) => request(axios, basePath));
        },
    };
};
/**
...
class DefaultApi extends base_1.BaseAPI {
     ...
     */
    getAllStrategies(options) {
        return exports.DefaultApiFp(this.configuration).getAllStrategies(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @param {'port' | 'appDir'} key
     ...
     */
    writeStrategy(fileName, writeStrategyOptions, options) {
        return exports.DefaultApiFp(this.configuration).writeStrategy(fileName, writeStrategyOptions, options).then((request) => request(this.axios, this.basePath));
    }
}
