...
class StrategyService {
    ...
    getAllStrategyMetaData() {
        const dirContents = fs_1.default.readdirSync(this.strategyDir);
        const dirFiles = dirContents.filter((fileOrDir) => {
            const fullPath = path_1.default.join(this.strategyDir, fileOrDir);
